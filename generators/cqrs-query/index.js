...
module.exports = class extends Generator {
  ...
  Install() {
    ...
    this.log(chalk.green("queries/handlers/index.ts"));
    this.log(
      ` import { ${this.variables.namePascal}Handler } from './${this.variables.name}.handler';`
    );
    this.log(``);

    this.log(chalk.green("queries/impl/index.ts"));
    this.log(
      ` export { ${this.variables.namePascal}Query } from './${this.variables.name}.query';`
    );
    this.log(``);
    this.log(``);
  }
