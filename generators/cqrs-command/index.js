...
module.exports = class extends Generator {
  ...
  Install() {
    ...
    this.log(chalk.green("commands/handlers/index.ts"));
    this.log(
      ` import { ${this.variables.namePascal}Handler } from './${this.variables.name}.handler';`
    );
    this.log(``);

    this.log(chalk.green("commands/impl/index.ts"));
    this.log(
      ` export { ${this.variables.namePascal}Command } from './${this.variables.name}.command';`
    );
    this.log(``);
    this.log(``);
  }
